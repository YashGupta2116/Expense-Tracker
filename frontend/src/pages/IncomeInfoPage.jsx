...
const IncomeInfoPage = () => {
  ...
  const validateForm = () => {
    if (formData.monthlyIncome <= 1000)
      return toast.error('Monthly income should be greater than 1000', {
        style: {
          borderRadius: '10px',
          background: '#333',
          color: '#fff',
    ...
    if (!options.includes(formData.occupation.trim().toLowerCase()))
    ...
    if (!formData.savingGoal.trim() > 1000)
      return toast.error('Saving Goal is required', {
        style: {
          borderRadius: '10px',
          background: '#333',
          color: '#fff',
    ...
    if (formData.monthlyIncome <= formData.savingGoal)
      return toast.error('Saving Goal cannot be greater than income', {
        style: {
          borderRadius: '10px',
          background: '#333',
          color: '#fff',
    ...
    <div className='min-h-screen grid lg:grid-cols-2'>
      ...
      <div className='hidden lg:block relative overflow-hidden bg-gray-900'>
        ...
        <div className='absolute bottom-48 left-20 text-white '>
          ...
          />
          <p className='text-lg text-white/80 ml-8'>
